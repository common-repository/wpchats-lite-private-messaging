...
class WPC_admin_screen_users_banned
{
	...
	public function screen() {
		...
		if( empty( $users ) ) :;
			...
			?>
				...
				<div style="display: table; margin: 0 auto; padding: 2em; font-weight: 600; font-style: italic;">
					<p>You don't have any banned users for the moment.</p>
				</div>
		...
		$base_url = 'admin.php?page=wpchats-users&tab=banned';
...
WPC_admin_screen_users_banned::instance()->screen();